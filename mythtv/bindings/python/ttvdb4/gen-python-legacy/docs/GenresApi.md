...
# **get_all_genres**
> InlineResponse20020 get_all_genres()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_all_genres()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GenresApi->get_all_genres: %s\n" % e)
```
...
# **get_genre_base**
> InlineResponse20021 get_genre_base(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_genre_base(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GenresApi->get_genre_base: %s\n" % e)
```
