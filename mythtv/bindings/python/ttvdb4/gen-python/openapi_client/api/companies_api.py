...
class CompaniesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_companies = _Endpoint(
            settings={
        ...
        self.get_company_types = _Endpoint(
            settings={
                'response_type': (InlineResponse20012,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/companies/types',
                'operation_id': 'get_company_types',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
