...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArtworkApi()
        api_instance.get_artwork_base  # this is an instance of the class Endpoint
        api_instance.get_artwork_base()  # this invokes api_instance.get_artwork_base.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_artwork_base.callable or self.callable in this class
