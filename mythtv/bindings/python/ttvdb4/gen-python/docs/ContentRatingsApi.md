# openapi_client.ContentRatingsApi
...
> InlineResponse20014 get_all_content_ratings()
...
from openapi_client.api import content_ratings_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = content_ratings_api.ContentRatingsApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_all_content_ratings()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling ContentRatingsApi->get_all_content_ratings: %s\n" % e)
```
