# openapi_client.SeriesStatusesApi
...
> InlineResponse20027 get_all_series_statuses()
...
from openapi_client.api import series_statuses_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = series_statuses_api.SeriesStatusesApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_all_series_statuses()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling SeriesStatusesApi->get_all_series_statuses: %s\n" % e)
```
