...
# **get_all_languages**
> InlineResponse20022 get_all_languages()
...
from openapi_client.api import languages_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_all_languages()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling LanguagesApi->get_all_languages: %s\n" % e)
```
