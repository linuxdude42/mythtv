# openapi_client.MovieStatusesApi
...
> InlineResponse20027 get_all_movie_statuses()
...
from openapi_client.api import movie_statuses_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = movie_statuses_api.MovieStatusesApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_all_movie_statuses()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling MovieStatusesApi->get_all_movie_statuses: %s\n" % e)
```
