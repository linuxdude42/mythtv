...
> InlineResponse20031 get_all_people_types()
...
from openapi_client.api import people_types_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = people_types_api.PeopleTypesApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_all_people_types()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling PeopleTypesApi->get_all_people_types: %s\n" % e)
```
