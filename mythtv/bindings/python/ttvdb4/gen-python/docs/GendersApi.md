...
# **get_all_genders**
> InlineResponse20019 get_all_genders()
...
from openapi_client.api import genders_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = genders_api.GendersApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_all_genders()
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling GendersApi->get_all_genders: %s\n" % e)
```
