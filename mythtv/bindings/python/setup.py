...
setup(
        ...
        packages=['MythTV', 'MythTV/tmdb3', 'MythTV/ttvdb', 'MythTV/tvmaze',
                  'MythTV/ttvdb4',
                  'MythTV/ttvdb4.openapi_client',
                  'MythTV/ttvdb4.openapi_client.api',
                  'MythTV/ttvdb4.openapi_client.apis',
                  'MythTV/ttvdb4.openapi_client.model',
                  'MythTV/ttvdb4.openapi_client.models',
                  'MythTV/ttvdb4l',
                  'MythTV/ttvdb4l.openapi_client',
                  'MythTV/ttvdb4l.openapi_client.api',
                  'MythTV/ttvdb4l.openapi_client.models',
                  'MythTV/wikiscripts', 'MythTV/utility',
				  'MythTV/services_api'],
        package_dir={'MythTV/tmdb3':'./tmdb3/tmdb3',
                     'MythTV/ttvdb4':'./ttvdb4/gen-python',
                     'MythTV/ttvdb4l':'./ttvdb4/gen-python-legacy',
