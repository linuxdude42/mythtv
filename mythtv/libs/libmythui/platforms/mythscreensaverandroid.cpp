...
{
    //jint keepScreenOn = QJniObject::getStaticObjectField<jint>("android/view/WindowManager/", "ACTION_CALL");
}
...
void MythScreenSaverAndroid::Disable()
{
    ...
    if (activity.isValid()) {
        ...
        if (window.isValid()) {
            ...
            //QJniObject keepScreenOn = QJniObject::fromString("WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON");
