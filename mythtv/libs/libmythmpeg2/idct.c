...
static inline void idct_col (int16_t * const block)
{
    ...
    int d0 = (block[ROWSIZE*0] << 11) + 65536;
    int d1 = block[ROWSIZE*1];
    int d2 = block[ROWSIZE*2] << 11;
    int d3 = block[ROWSIZE*3];
    int t0 = d0 + d2;
    int t1 = d0 - d2;
    BUTTERFLY (t2, t3, W6, W2, d3, d1);
    int a0 = t0 + t2;
    ...
    block[ROWSIZE*0] = (a0 + b0) >> 17;
    block[ROWSIZE*1] = (a1 + b1) >> 17;
    block[ROWSIZE*2] = (a2 + b2) >> 17;
    block[ROWSIZE*3] = (a3 + b3) >> 17;
    block[ROWSIZE*4] = (a3 - b3) >> 17;
    block[ROWSIZE*5] = (a2 - b2) >> 17;
    block[ROWSIZE*6] = (a1 - b1) >> 17;
    block[ROWSIZE*7] = (a0 - b0) >> 17;
}
