...
#if defined(USING_VAAPI) || defined (USING_VTB) || defined (USING_MEDIACODEC) || CONFIG_VDPAU || defined (USING_NVDEC) || defined (USING_MMAL) || defined (USING_V4L2PRIME) || defined (USING_EGL)
