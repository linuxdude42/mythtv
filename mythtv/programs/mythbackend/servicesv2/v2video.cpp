                                  ...
                                  const QString &sCountries)
{
    ...
    if (HAS_PARAMv2("Genres"))
    {
        ...
        std::ranges::transform(genresList, std::back_inserter(genres),
                       [](const QString& name)
    ...
    if (HAS_PARAMv2("Cast"))
    {
        ...
        std::ranges::transform(castList, std::back_inserter(cast),
                       [](const QString& name)
    ...
    if (HAS_PARAMv2("Countries"))
    {
        ...
        std::ranges::transform(countryList, std::back_inserter(countries),
                       [](const QString& name)
