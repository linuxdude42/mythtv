...
#
# NOTE: Try using find_package again. Can't remember what failed.
#
# find_package(exiv2 0.27.99 REQUIRED)
#
pkg_check_modules(EXIV2 "exiv2>=0.27.99" REQUIRED IMPORTED_TARGET)
...
if(ENABLE_BINDINGS_PHP)
  ...
  elseif(PHPModules_COMPONENTS_MISSING)
...
if(ENABLE_FIREWIRE)
  ...
  if(TARGET PkgConfig::LibAVC1394 AND TARGET PkgConfig::LibIEC61883)
    ...
    if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin" AND NOT ${MYTH_FIREWIRE_SDK})
